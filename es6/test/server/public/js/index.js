...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 深度拷贝
	var copyProerties = function copyProerties(target, source) {
	...
	var mix = function mix() {
	    ...
	    try {
	        for (var _iterator2 = mixins[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            ...
	            copyProerties(Mix, mixin);
	            copyProerties(Mix.prototype, mixin.prototype);
	        }
	    } catch (err) {
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function assistHandle(e) {
	            ...
	            if (index === 1) {
	                (0, _jquery2.default)('.boll-list .btn-boll').each(function (index, item) {
	        ...
	        value: function addCodeItem(code, type, typeName, count) {
	            ...
	            (0, _jquery2.default)(self.cart_el).append(tlp);
	            self.getTotal();
	        }
	    }, {
	        key: 'getCount',
	        value: function getCount() {
	            ...
	            (0, _jquery2.default)('.sel_info').html(tlp);
	        }
	...
	var Calculate = function () {
	    ...
	    _createClass(Calculate, [{
	        ...
	        value: function computeBonus(active, play_name) {
	            var play = play_name.split(''); //玩法的基数
	            var self = this; //当前对象指向
	            var arr = new Array(play[1] * 1).fill(0);
	            var min = void 0,
	                max = void 0; //定义最大值和最小值
	            if (play[0] === 'r') {
